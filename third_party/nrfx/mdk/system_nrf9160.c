...
#define __SYSTEM_CLOCK                                                                             \
	(64000000UL) /*!< nRF9160 Application core uses a fixed System Clock Frequency of 64MHz */
 ...
 * Nordic SPU should handle Secure Attribution tasks */
	...
	/* Workaround for Errata 6 "POWER: SLEEPENTER and SLEEPEXIT events asserted after pin reset"
	...
	/* Workaround for Errata 20 "RAM content cannot be trusted upon waking up from System ON
...
/* Enable Trace functionality. If ENABLE_TRACE is not defined, TRACE pins will be used as GPIOs (see
	...
	*((uint32_t*)(0xE0058FB0ul)) = 0x00000000ul;
	 ...
	 * Some debug probes may require manual configuration of these peripherals to enable
	 * tracing. ETB_BASE = 0xE0051000 TPIU_BASE = 0xE0054000
	 */
#endif
